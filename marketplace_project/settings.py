...
STATIC_URL = '/static/'
# STATICFILES_DIRS which defines the location of static files in local
# development
...
# STATICFILES_FINDERS which tells Django how to look for static
# file directories. OPTIONAL STEP
STATICFILES_FINDERS = [
